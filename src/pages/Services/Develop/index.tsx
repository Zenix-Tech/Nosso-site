...
const Develop: React.FC = () => {
  return(
      <>
        <Header/>
        <Container>
            <Services img={siteDev} alt="Desenvolvimento de sites" title="Desenvolvimento de sites"
            ...
            />
             <Services color="#F2F2F2" img={appsDev} alt="Desenvolvimento de aplicativos" title="Desenvolvimento de APP's"
            ...
            />
             <Services img={systemDev} alt="Desenvolvimento de sistemas" title="Desenvolvimento de sistemas"
