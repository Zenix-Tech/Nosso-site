...
const Marketing: React.FC = () => {
  return(
    ...
    <Header/>
      <Container>
        <ServicesItem img={mktDigital} alt="Marketing digital" title="Marketing digital" 
        ...
        />
        <ServicesItem img={visualId} alt="Identidade visual" title="Identidade visual" 
          ...
          color="#F2F2F2"
        />
        <ServicesItem img={uxuiDesign} alt="UX/ UI Design" title="UX/ UI Design" 
